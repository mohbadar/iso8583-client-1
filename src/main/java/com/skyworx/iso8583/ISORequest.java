 ...
 * Added com.skyworx.iso8583.ISORequest.isTransmitted() support
 *
 ...
 * <b>com.skyworx.iso8583.ISOMUX</b>
 *
...
public class ISORequest implements LogSource, Loggeable {
    ...
    /**
     * creates an com.skyworx.iso8583.ISORequest suitable to be queued to an com.skyworx.iso8583.ISOMUX
     ...
     * (used internally by com.skyworx.iso8583.ISOMUX)
     */
     ...
     * @param mux - an com.skyworx.iso8583.ISOMUX
     */
     ...
     * com.skyworx.iso8583.ISOMUX will notify this object when the response message is ready.
     *
    ...
    public ISOMsg getResponse(int timeout) {
        ...
        Logger.log (new LogEvent (this, "com.skyworx.iso8583.ISORequest", this));
        return response;
    }
    ...
    /**
     * called by com.skyworx.iso8583.ISOMUX to set the response and notify this
