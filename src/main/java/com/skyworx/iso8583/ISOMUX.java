                               ...
                               Configurable, Loggeable, ISOMUXMBean
{
    ...
    private void initMUX (ISOChannel c) {
        ...
        rx = new Thread (new Receiver(this),"com.skyworx.iso8583.ISOMUX-Receiver");
        name = "";
        muxInstance = this;
    }
    /**
    ...
    */
    ...
    /**
     * queue an com.skyworx.iso8583.ISORequest
     */
    ...
    /**
     * associates this com.skyworx.iso8583.ISOMUX with a name using NameRegistrar
    ...
    /**
     * @return com.skyworx.iso8583.ISOMUX instance with given name.
    ...
    /**
     * @return this com.skyworx.iso8583.ISOMUX's name ("" if no name was set)
     */
